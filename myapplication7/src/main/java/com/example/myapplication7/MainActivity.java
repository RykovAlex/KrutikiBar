...
public class MainActivity extends Activity implements AdapterView.OnItemClickListener {
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        int[] to = {R.id.Текст, R.id.tvValue, R.id.ivImg};

        // создаем адаптер
        sAdapter = new MySimpleAdapter(this, data,
    ...
    public void onItemClick(AdapterView<?> parent, View view, int position, long id) {
        Log.d("myLogs", "itemClick: position = " + position + ", id = " + id);
    ...
    class MySimpleAdapter extends SimpleAdapter {
        ...
        public void setViewText(TextView v, String text) {
            ...
            if (v.getId() == R.id.tvValue) {
                ...
                //if (i < 0) ((LinearLayout)v.getParent().getParent()).setBackgroundColor(Color.RED); else
